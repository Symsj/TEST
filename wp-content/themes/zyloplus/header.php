  ...
  <div class="clear"></div>
        ...
        <div class="container">
            <div class="logo">
             ...
             <div class="hdrright">
             <div class="toggle">
                <a class="toggleMenu" href="#"><?php _e('Menu','zyloplus'); ?></a>
             </div><!-- toggle --> 
	...
	<?php $hideslide = get_theme_mod('zyloplus_disabled_slides', '1'); ?>
		<?php if($hideslide == ''){ ?>
              <?php for($sld=7; $sld<10; $sld++) { ?>
                	...
                	<?php $slidequery = new WP_Query('page_id='.esc_attr(get_theme_mod('zyloplus_pagesetting'.$sld,true))); ?>
                    ...
                    <?php 	$zyloplus_whychooseus_title = get_theme_mod('zyloplus_whychooseus_title');
                     ...
                     <?php for($p=1; $p<5; $p++) { ?>       
                        <?php if( get_theme_mod('zyloplus_pagecolumn'.$p,false)) { ?>          
                            <?php $querymax = new WP_Query('page_id='.esc_attr(get_theme_mod('zyloplus_pagecolumn'.$p,true))); ?>				
