									...
									<div class="title_area">
										...
										<div class="post_info post_info_2">
 											<span class="post_author"> <i class="fa fa-calendar"></i>
											  ...
											  <?php } ?>
                          						<div class="post_comments"><a><i class="fa fa-comments"></i><span class="comments_number"> <?php comments_popup_link( __('0 Comment', 'untold'), __('1 Comment', 'untold'), __('% Comments', 'untold'), '', __('Off' , 'untold')); ?> </span><span class="icon-comment"></span></a></div>  
											...
											<div class="post_content">
												...
												<div class="readmore">
													<a href="<?php echo esc_url(get_permalink());?>" rel="bookmark" class="more-link">
														<?php echo esc_attr__('Read more','untold');?>
     												</a>
												</div>
